...
export default function PhotoCarousel() {
  return (
    <section id="galerija" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="mt-12 text-center text-zinc-400 font-bold text-[10px] uppercase tracking-[0.4em] italic">
