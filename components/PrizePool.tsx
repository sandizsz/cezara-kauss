    ...
    <section className="py-16 md:py-24 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-8 md:mb-16">
          <span className="section-label mb-3 md:mb-6 !bg-cesar-gold !text-black">REWARDS</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          <div className="bg-zinc-900/80 p-6 md:p-12 border-t-4 border-zinc-500 text-center flex flex-col items-center order-2 md:order-1">
            ...
            <h3 className="font-display text-3xl md:text-5xl text-white mb-2 md:mb-4">MEDAĻAS + PĀRSTEIGUMI</h3>
            <p className="text-zinc-500 text-[10px] md:text-xs font-bold uppercase tracking-widest">NO SPONSORIEM</p>
          </div>
          ...
          <div className="bg-zinc-900 p-8 md:p-16 border-t-8 border-cesar-gold text-center flex flex-col items-center md:scale-105 shadow-[0_0_50px_rgba(212,175,55,0.2)] relative order-1 md:order-2">
            <div className="absolute -top-6 bg-cesar-gold text-black px-4 md:px-6 py-1 font-black text-[10px] uppercase tracking-widest">GRAND CHAMPION</div>
            ...
            <p className="text-cesar-gold font-black uppercase tracking-widest text-xs md:text-sm">SKAIDRĀ NAUDĀ + KAUSS</p>
          </div>
          ...
          <div className="bg-zinc-900/80 p-6 md:p-12 border-t-4 border-zinc-500 text-center flex flex-col items-center order-3">
            ...
            <p className="text-zinc-500 text-[10px] md:text-xs font-bold uppercase tracking-widest">UN DIPLOMI</p>
          </div>
        </div>
      </div>
    </section>
