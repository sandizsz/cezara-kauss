            ...
            return (
              ...
              >
                <div className={`absolute inset-0 transition-opacity duration-500 ${isExpanded ? 'opacity-100' : 'opacity-0 md:group-hover:opacity-100'}`}>
                  <img src={w.image} alt={`${w.team} ${w.year}`} className="w-full h-full object-cover" />
                    ...
                    <div className="overflow-hidden">
                      <div className="pt-4 space-y-3">
                        <div className="text-center">
                          <span className="text-[10px] font-black text-cesar-gold tracking-[0.3em] uppercase">{t("finalResult")}</span>
