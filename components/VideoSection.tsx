    ...
    <section id="video" className="py-24 bg-black relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <span className="section-label mb-6">ATMOSFĒRA</span>
          ...
          <p className="mt-8 text-zinc-500 font-extrabold text-[10px] uppercase tracking-[0.5em] italic">
            Ieskats iepriekšējā gada spilgtākajos mirkļos
          </p>
        </div>

        <div className="relative group max-w-5xl mx-auto bg-zinc-900/50 p-12">
          <div className="absolute inset-0 border-2 border-cesar-gold/20 -m-2 pointer-events-none"></div>
          <div className="relative aspect-video bg-zinc-900 border-4 border-white overflow-hidden shadow-2xl">
            <iframe
            ...
            <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-all flex items-center justify-center cursor-pointer pointer-events-none">
              <div className="w-24 h-24 bg-cesar-gold/90 rounded-full flex items-center justify-center border-4 border-black group-hover:scale-110 transition-transform">
