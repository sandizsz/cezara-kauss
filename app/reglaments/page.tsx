...
const sections = [
  {
    ...
    items: [
      ...
      '1.2 Noskaidrot "Cēzara Kauss" labākās futbola komandas;',
  ...
  },
  {
    ...
    items: [
      '2.1 Turnīra organizators ir biedrība "Futbols Gulbenē". (turpmāk tekstā – Organizators), e-pasts: cezarakauss@gmail.com / tel.: 25726717;',
      "2.2 Sacensību galvenais tiesnesis Artēmijs Semjonovs (e-pasts: cezarakauss@gmail.com / tel.: 25726717).",
    ],
  },
  {
    title: "3. TURNĪRA NORISES VIETA UN LAIKS",
    items: [
      '3.1. "Cēzara Kauss" norisināsies 2026.gada 26.jūlijā, Gulbenes pilsētas stadionā, O.Kalpaka iela 1a.',
    ],
  },
  {
    title: "4. DALĪBNIEKI",
  ...
  },
  {
    ...
    items: [
      ...
      "5.3 Komandas var pieteikt savu dalību turnīrā ne vēlāk kā 7 kalendārās dienas līdz turnīra sākumam (26. jūlijs);",
  ...
  },
  {
    ...
    items: [
      ...
      "6.11 Komandas neierašanās gadijumā tiek piešķirts tehniskais zaudējums 0:5.",
    ],
    footnotes: [
  ...
  },
  {
    ...
    items: [
      '9.2 Par spļaušanu personai, "pēdējās cerības" sodu, tīšu speršanu, mešanu ar priekšmetu kādam, tīšu sitienu un abpusēju rupjību – noraidījums un jāizlaiž nākamā spēle (ja pārkāpums nav īpaši rupjš). Par šāda veida atkārtotu pārkāpumu diskvalifikācija uz visu turnīru;',
      ...
      "9.6 Par spēlētāja, kurš nav iekļauts protokolā, piedalīšanos spēlē, komandai tiek piešķirts tehniskais zaudējums 0:W.",
    ],
  },
  {
    title: "10. MEDICĪNA",
